...
def extract_tables_from_html_file(html_file, arxiv_id):
    ...
    output_dir = r'C:\Users\h.zheng\Documents\Ingegneria dei Dati\ID-Homerworks\homework1\Pose_Estimation\extraction'
...
def main():
    # Esempio di utilizzo
    process_html_files_in_directory(r'C:\Users\h.zheng\Documents\Ingegneria dei Dati\ID-Homerworks\homework1\Pose_Estimation\sources_RAG')
